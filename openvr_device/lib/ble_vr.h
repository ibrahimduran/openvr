...
class BleVRConnectionStatus : public BLEServerCallbacks {
public:
  BleVRConnectionStatus(void);
...
private:
  ...
  BLEHIDDevice* hid;
  BLECharacteristic* characteristic;
  BleVRConnectionStatus* connectionStatus;
  uint8_t* data;
  size_t size;
public:
  BleVR(std::string deviceName, std::string deviceManufacturer, uint8_t batteryLevel);
  ...
  void setGripPressed(bool pressed);
  void setSystemPressed(bool pressed);
  void setApplicationPressed(bool pressed);
